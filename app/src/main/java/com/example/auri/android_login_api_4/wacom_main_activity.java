...
import static com.wacom.cdl.deviceservices.DeviceServiceType.*;

public class wacom_main_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wacom_test);

        //Request permissions
        ActivityCompat.requestPermissions(wacom_main_activity.this,
        ...
        transferFilesBtn = findViewById(R.id.transferFilesBtn);
        liveMode =  findViewById(R.id.liveModeBtn);
    ...
    private void startInkDevice(final InkDeviceInfo inkDeviceInfo){
        ...
        try {
            ...
            Toast.makeText(wacom_main_activity.this, "License is invalid", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
            return;
        }


        app.subscribeForEvents(wacom_main_activity.this);
        app.subscribeForAlerts(wacom_main_activity.this);

        ArrayList<DeviceServiceType> availableDeviceServices = inkDevice.getAvailableDeviceServices();

        if (availableDeviceServices.contains(FILE_TRANSFER_DEVICE_SERVICE)) {
            transferFilesBtn.setVisibility(View.VISIBLE);
        }

        if(availableDeviceServices.contains(LIVE_MODE_DEVICE_SERVICE)){
        ...
        inkDevice.connect(inkDeviceInfo, appId, new ConnectionCallback() {
            ...
            public void onConnected() {
                ...
                devicesAdapter = new ArrayAdapter<>(wacom_main_activity.this,
                        android.R.layout.simple_list_item_1,
                        deviceProperties);
    ...
    private boolean hasPermission(String permission){
        return ContextCompat.checkSelfPermission(wacom_main_activity.this,
                permission)
